  ...
  return (
    <section className="flex flex-col gap-3 sm:gap-4">
      ...
      <div className="space-y-2 sm:space-y-3">
        <SubTitle>
          <Code className="text-gray-blue text-lg sm:text-xl lg:text-[24px] font-medium">{`colbrush-cli`}</Code>
        </SubTitle>
        <Bullet option="설명: ">
          <Code className="text-black">colbrush</Code> 라이브러리의 핵심 기능을
          담당하는 커맨드라인 도구입니다.
        </Bullet>
        <Bullet option="명령어:"></Bullet>
        <Bullet>
        ...
        <Bullet>
          <Code className="text-black">{`--css=<path>`}</Code> : 테마를 생성할 CSS
          파일의 경로를 지정합니다. 기본값은
