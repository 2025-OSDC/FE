...
export default function Usage() {
  ...
  return (
    <div className="text-center font-pretendard font-semibold lg:mb-[200px] max-lg:mb-[160px]">
      <h1 className="text-[32px] max-lg:text-[24px] font-bold text-gray-900 mt-[100px] mb-[80px]">다양한 색맹 유형에 맞춘<br />최적의 테마를 경험해 보세요</h1>
      ...
      <div className={`flex flex-col lg:gap-[90px] max-lg:gap-[60px]  px-[12.5%]`}>
        {/* 그래프 */}
        ...
        <div>
          <div className={`flex flex-col gap-6`}>
            ...
            <div className={`rounded-[28px] shadow-custom w-full px-6 py-10 flex flex-row max-md:flex-col gap-5`}>
